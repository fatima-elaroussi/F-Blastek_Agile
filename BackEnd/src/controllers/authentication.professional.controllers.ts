...
export const loginProfessional = async (req: Request, res: Response) : Promise<void>=> {
  ...
  if (professionalExist) {
    bcryptjs
      ...
      .then((isMatch: boolean) => {
        if (isMatch) {
          const payload = { id: professionalExist.id, role: "professional" };
...
export const logoutProfessional = (req: Request, res: Response) : void=> {
  res
